<main class="articles" id="post-<?php echo $this->id; ?>">
	<article class="<?php echo $this->classes; ?>">
		...
		<?php if ($this->thumbnail->exists) :
			echo $this->thumbnail->img; // see od/includes/images.php line 101 for styling & output
		endif; ?>
		...
		<div class="streetview">
			...
			<span
				...
				data-enabletxt="<?php _e('Toon streetview', 'od'); ?>"
				data-disableTxt="<?php _e('Verberg streetview', 'od'); ?>"
			>
				<?php _e('Toon streetview', 'od'); ?>
			</span>
		</div>
		<?php endif; ?>
	...
	<?php if( $this->aRelated ) : ?>
		<div class="row related-markers">
			<h2><?php _e('Gerelateerde markers', 'od'); ?></h2>
	...
	<?php if( $this->aYears ) : ?>
		<div class="row marker-years">
			<h2><?php _e('Deze marker komt voor in:', 'od'); ?></h2>
			<ul>
