...
MapHist.Map = function(elContainer, oApp) {
	...
	this.searchMarker = new google.maps.Marker({
	    map: null,
	    draggable: false,
	    icon: '/wp-content/themes/mappinghistory/dist/svg/markersearch-result.svg',
	    cursor: 'hand'
	});
...
MapHist.Map.prototype = {
	...
	setEvents: function(){
		...
		// Search address form
		document.querySelector('.search-address').addEventListener("submit", function(e) {
			// get address
	...
	setMarkerClustering: function(){
		var mcOptions = {
			...
			maxZoom: 15,
			styles: [{
				url: '/wp-content/themes/mappinghistory/dist/svg/marker-cluster.svg',
				width: 33,
				height: 50,
				anchor: [3.5, 0],
				textColor: '#757172',
